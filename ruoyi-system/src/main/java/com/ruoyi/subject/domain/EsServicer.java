...
public class EsServicer extends BaseEntity
{
    ...
    /** 有形性得分 */
    @Excel(name = "有形性得分")
    private BigDecimal TangiSc;

    /** 可靠性得分 */
    @Excel(name = "可靠性得分")
    private BigDecimal ReliSc;

    /** 响应性得分 */
    @Excel(name = "响应性得分")
    private BigDecimal ResponSc;

    /** 保证性得分 */
    @Excel(name = "保证性得分")
    private BigDecimal AssuranceSc;

    /** 移情性得分 */
    @Excel(name = "移情性得分")
    private BigDecimal EmpathySc;
    ...
    /**
     * 支持前端以数组方式提交省市县区镇，后端自动拼接为字符串
     */
    public void setRegionPre(List<String> regionPreParts)
    {
        if (regionPreParts == null || regionPreParts.isEmpty())
        {
            this.regionPre = null;
        }
        else
        {
            this.regionPre = String.join("/", regionPreParts);
        }
    }
    ...
    public void setTangiSc(BigDecimal TangiSc) 
    {
        this.TangiSc = TangiSc;
    }

    public BigDecimal getTangiSc() 
    {
        return TangiSc;
    }
    public void setReliSc(BigDecimal ReliSc) 
    {
        this.ReliSc = ReliSc;
    }

    public BigDecimal getReliSc() 
    {
        return ReliSc;
    }
    public void setResponSc(BigDecimal ResponSc) 
    {
        this.ResponSc = ResponSc;
    }

    public BigDecimal getResponSc() 
    {
        return ResponSc;
    }
    public void setAssuranceSc(BigDecimal AssuranceSc) 
    {
        this.AssuranceSc = AssuranceSc;
    }

    public BigDecimal getAssuranceSc() 
    {
        return AssuranceSc;
    }
    public void setEmpathySc(BigDecimal EmpathySc) 
    {
        this.EmpathySc = EmpathySc;
    }

    public BigDecimal getEmpathySc() 
    {
        return EmpathySc;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("TangiSc", getTangiSc())
            .append("ReliSc", getReliSc())
            .append("ResponSc", getResponSc())
            .append("AssuranceSc", getAssuranceSc())
            .append("EmpathySc", getEmpathySc())
            .append("TotalSc", getTotalSc())
            .toString();
    }
}
