...
public class EsStandardsController extends BaseController
{
     ...
     * 查询标准管理列表
     */
    @PreAuthorize("@ss.hasPermi('base:standards:list')")
    @GetMapping("/list")
     ...
     * 导出标准管理列表
     */
    @PreAuthorize("@ss.hasPermi('base:standards:export')")
     ...
     * 获取标准管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('base:standards:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增标准管理
     */
    @PreAuthorize("@ss.hasPermi('base:standards:add')")
     ...
     * 修改标准管理
     */
    @PreAuthorize("@ss.hasPermi('base:standards:edit')")
     ...
     * 删除标准管理
     */
    @PreAuthorize("@ss.hasPermi('base:standards:remove')")
