...
import com.ruoyi.system.service.IEsMachineryService;
 ...
 */
@RestController
@RequestMapping("/system/machinery")
public class EsMachineryController extends BaseController
{
     ...
     * 查询农机列表
     */
    @PreAuthorize("@ss.hasPermi('system:machinery:list')")
    @GetMapping("/list")
     ...
     * 导出农机列表
     */
    @PreAuthorize("@ss.hasPermi('system:machinery:export')")
     ...
     * 获取农机详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:machinery:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增农机
     */
    @PreAuthorize("@ss.hasPermi('system:machinery:add')")
     ...
     * 修改农机
     */
    @PreAuthorize("@ss.hasPermi('system:machinery:edit')")
     ...
     * 删除农机
     */
    @PreAuthorize("@ss.hasPermi('system:machinery:remove')")
