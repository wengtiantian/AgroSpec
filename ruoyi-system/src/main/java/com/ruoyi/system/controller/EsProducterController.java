...
import com.ruoyi.system.domain.EsProducter;
import com.ruoyi.system.service.IEsProducterService;
 ...
 */
@RestController
@RequestMapping("/system/producter")
public class EsProducterController extends BaseController
{
     ...
     * 查询生产主体管理列表
     */
    @PreAuthorize("@ss.hasPermi('system:producter:list')")
    @GetMapping("/list")
     ...
     * 导出生产主体管理列表
     */
    @PreAuthorize("@ss.hasPermi('system:producter:export')")
     ...
     * 获取生产主体管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:producter:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增生产主体管理
     */
    @PreAuthorize("@ss.hasPermi('system:producter:add')")
     ...
     * 修改生产主体管理
     */
    @PreAuthorize("@ss.hasPermi('system:producter:edit')")
     ...
     * 删除生产主体管理
     */
    @PreAuthorize("@ss.hasPermi('system:producter:remove')")
